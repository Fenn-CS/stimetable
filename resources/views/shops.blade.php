...
<div class="container">
    <div class="row" style="padding:20px;">
        <input class="form-control col-md-10" placeholder="Find stuff near you..." style="height: 60px; border-radius:5px;">
        <button class="btn btn-default col-md-2" style="height:60px; border:1px solid #ddd;">
    ...
    <div class="list-group">
        <div class="card mb-3">
            <div class="row no-gutters">
                ...
                <div class="col-md-6" style="padding: 20px;">
                    <div class="card-body">
                        <h5 class="card-title">Zipkers Groceries</h5>
                        <p class="card-text">
                        7832 Golden Star Street, South San Francisco, CA 94080
                        </p>
                        <p class="card-text">
                ...
                <div class="col-md-3">
                    <a class="btn btn-primary mt-2" href="{{ route('timetable') }}">
                        Subscribe
                    </a>
                </div>
            </div>
        ...
        <div class="card mb-3">
            <div class="row no-gutters">
                ...
                <div class="col-md-6" style="padding: 20px;">
                    <div class="card-body">
                        <h5 class="card-title">Kroger Co.</h5>
                        <p class="card-text">
                        7832 Golden Star Street, South San Francisco, CA 94080
                        </p>
                        <p class="card-text">
        ...
        <div class="card mb-3">
            <div class="row no-gutters">
                ...
                <div class="col-md-6" style="padding: 20px;">
                    <div class="card-body">
                        <h5 class="card-title">Whole Foods Market, Inc</h5>
                        <p class="card-text">
                        3435 Zulips Bridge, South San Francisco, CA 94080
                        </p>
                        <p class="card-text">
                            <small class="badge badge-success">open</small>
                        </p>
